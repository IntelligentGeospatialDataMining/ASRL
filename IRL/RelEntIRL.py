from IRL.utils import feature_averages
import numpy as np

class RelEntIRL:
    def __init__(self,expert_demos,nonoptimal_demos):
        self.expert_demos = expert_demos
        self.nonoptimal_demos = nonoptimal_demos      #100*n*num_fea
        self.num_features = 5 # feature num of state
    ...
    def train(self,step_size=1e-4,num_iters=50000,print_every=1000):
